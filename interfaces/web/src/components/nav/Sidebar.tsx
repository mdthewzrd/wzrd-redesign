...
import { ChevronRight, ChevronLeft, MessageSquare, BarChart3, Zap, FileText, Database, Link2, Server, Settings, ScrollText, Brain, Trophy, Layers, FileCode, RefreshCw, Container } from 'lucide-react';
