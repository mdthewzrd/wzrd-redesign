...
export const TAB_GROUPS = [
  ...
  { label: 'control', tabs: ['overview', 'activity', 'topics', 'tasks', 'mcp', 'instances', 'recommendations'] },
  { label: 'wzrd', tabs: ['files', 'memory', 'skills', 'gold-standard', 'blueprints'] },
  { label: 'settings', tabs: ['config', 'logs', 'sync', 'sandbox'] },
] as const;
...
export type Tab =
  ...
  | 'overview'
  | 'activity'
  | 'topics'  // NEW: Real topic management
  | 'tasks'
  | 'files'
  | 'mcp'
  | 'instances'
  ...
  | 'skills'
  | 'gold-standard'
  | 'blueprints'  // NEW: Blueprint Engine
  | 'sync'  // NEW: Interface Sync Dashboard
  | 'sandbox';  // NEW: Sandbox/Worktree Manager
...
export function iconForTab(tab: Tab): string {
  const icons: Record<Tab, string> = {
    ...
    memory: 'Brain',
    skills: 'Zap',
    'gold-standard': 'Trophy',
    blueprints: 'FileCode',  // NEW
    sync: 'RefreshCw',  // NEW
    sandbox: 'Container',  // NEW
  };
  return icons[tab];
}
...
export function subtitleForTab(tab: Tab): string {
  const subtitles: Record<Tab, string> = {
    ...
    activity: 'Live activity and usage feed',
    topics: 'Topic management and coordination',  // NEW
    tasks: 'Granular agent work breakdown',
    files: 'WZRD.dev file explorer',
    mcp: 'Model Context Protocol servers',
    instances: 'Running services and projects',
    recommendations: 'AI-powered insights and recommendations',
    config: 'Gateway configuration',
    logs: 'System logs',
    memory: 'Shared context and memory',
    skills: 'Agent capabilities',
    'gold-standard': 'Quality standards and learnings',
    blueprints: 'Blueprint workflows and executions',  // NEW
    sync: 'Cross-interface synchronization',  // NEW
    sandbox: 'Sandbox and worktree management',  // NEW
  };
