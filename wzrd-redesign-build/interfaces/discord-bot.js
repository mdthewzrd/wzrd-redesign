...
const unified_memory_1 = __importDefault(require("../memory/unified-memory"));
...
class TopicDiscordBot {
    constructor(config) {
        ...
        this.memory = new unified_memory_1.default({
            memoryBasePath: '/home/mdwzrd/wzrd-redesign/memory',
        });
