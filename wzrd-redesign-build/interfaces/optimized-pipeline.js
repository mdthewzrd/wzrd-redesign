...
class OptimizedPipeline {
   ...
   */
  async processMessage(message, onProgress, apiCallFn) {
    ...
    try {
      ...
      metrics.skillsLoaded = skillsResult.skills ? skillsResult.skills.length : 0;
      ...
      return {
        response: `I encountered an error: ${error.message}. How can I help?`,
        metrics,
        mode: 'CHAT',
        skills: []
      };
   ...
   */
  enhanceResponseWithSkills(response, skills) {
